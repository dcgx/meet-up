...
const mapUserFromFirebaseAuthToUser = (user) => {
  ...
  return { displayName, email, photoURL, username: reloadUserInfo.screenName }
}
...
export const signInWithGitHub = () => {
  return signInWithPopup(auth, provider).then((data) => mapUserFromFirebaseAuthToUser(data.user))
}
